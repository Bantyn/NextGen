...
export const DoctorDashboardView = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="w-full bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:justify-between gap-6 shadow-sm relative overflow-hidden">
        {/* Subtle Background Accents */}
        <div className="absolute top-0 right-0 -translate-y-12 translate-x-12 w-64 h-64 bg-sky-100/50 rounded-full blur-[60px] pointer-events-none"></div>
        <div className="absolute bottom-0 left-0 translate-y-12 -translate-x-12 w-48 h-48 bg-indigo-100/40 rounded-full blur-[50px] pointer-events-none"></div>
