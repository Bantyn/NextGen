    ...
    <div className="w-full max-w-5xl px-4 sm:px-6 pt-8 sm:pt-14 pb-16 flex flex-col items-center text-center mx-auto space-y-16">
      ...
      <section className="w-full flex flex-col items-center text-center">
        ...
        <p className="text-sm sm:text-base md:text-lg font-normal text-slate-500 max-w-2xl mx-auto leading-relaxed mt-3 mb-8">
          <strong>MediKiosk</strong> empowers patients to record comprehensive medical histories via natural voice conversation, scan past prescriptions, and generate structured, physician-ready summaries linked to their <strong>ABHA record</strong> before entering the consultation room.
        </p>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full max-w-3xl pt-4 border-t border-slate-200/70 text-left">
          <div className="p-3 rounded-2xl bg-white/70 border border-slate-200/80">
            <div className="text-xl sm:text-2xl font-normal text-slate-950">7+</div>
            <div className="text-[11px] text-slate-500 font-normal mt-0.5">Indian Languages (ASR + TTS)</div>
          </div>
          <div className="p-3 rounded-2xl bg-white/70 border border-slate-200/80">
            <div className="text-xl sm:text-2xl font-normal text-emerald-700">&lt; 3 mins</div>
            <div className="text-[11px] text-slate-500 font-normal mt-0.5">Complete Intake Time</div>
          </div>
          <div className="p-3 rounded-2xl bg-white/70 border border-slate-200/80">
            <div className="text-xl sm:text-2xl font-normal text-slate-950">10-Fold</div>
            <div className="text-[11px] text-slate-500 font-normal mt-0.5">AYUSH Dashavidha Pariksha</div>
          </div>
          <div className="p-3 rounded-2xl bg-white/70 border border-slate-200/80">
            <div className="text-xl sm:text-2xl font-normal text-sky-700">100%</div>
            <div className="text-[11px] text-slate-500 font-normal mt-0.5">Physician-Verified Sign-Off</div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full text-left space-y-6">
        <div className="text-center max-w-xl mx-auto">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-normal mt-1.5">
            Designed for high-throughput public kiosks and private hospital OPD networks.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="p-6 rounded-[28px] bg-white/90 backdrop-blur-md border border-slate-200/90 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-600 font-normal leading-relaxed">
              Adaptive dialogue manager constrained by the <strong>SOCRATES framework</strong> for acute symptoms. Includes dual-mode touch answering, priority <strong>Red-Flag triage detection</strong>, and <strong>AYUSH Dashavidha Pariksha</strong>.
            </p>
            <div className="pt-2 flex items-center gap-2 flex-wrap text-[11px] text-slate-500">
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">SOCRATES Tree</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Red-Flag Alerts</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Neural TTS</span>
            </div>
          </div>
          ...
          <div className="p-6 rounded-[28px] bg-white/90 backdrop-blur-md border border-slate-200/90 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-600 font-normal leading-relaxed">
              High-accuracy camera/PDF scanning of prior prescriptions and lab reports. Automatically extracts prescribed dosages, constructs a chronological medical timeline, and <strong>highlights abnormal lab values</strong>.
            </p>
            <div className="pt-2 flex items-center gap-2 flex-wrap text-[11px] text-slate-500">
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Dosage Extraction</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Abnormal Lab Flags</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Medical Timeline</span>
            </div>
          </div>
          ...
          <div className="p-6 rounded-[28px] bg-white/90 backdrop-blur-md border border-slate-200/90 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-600 font-normal leading-relaxed">
              Synthesizes conversational audio and digitized documents into a single standard clinical draft (CC ➔ HPI ➔ Past ➔ Drug ➔ ROS). Presented on the doctor's screen for rapid verification and editing.
            </p>
            <div className="pt-2 flex items-center gap-2 flex-wrap text-[11px] text-slate-500">
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Standard Format</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Editable Draft</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Bilingual Output</span>
            </div>
          </div>
          ...
          <div className="p-6 rounded-[28px] bg-white/90 backdrop-blur-md border border-slate-200/90 shadow-2xs space-y-3">
            ...
            <p className="text-xs text-slate-600 font-normal leading-relaxed">
              Granular, revocable consent with local-language audio explanations for low-literacy patients. ABHA ID authentication and automatic FHIR Bundle linking to the hospital HIS/EMR.
            </p>
            <div className="pt-2 flex items-center gap-2 flex-wrap text-[11px] text-slate-500">
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">ABHA ID Sync</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Audio Consent</span>
              <span className="bg-slate-100 px-2 py-0.5 rounded-md">Immediate Session Purge</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full text-left space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
          <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-2">
            ...
            <div className="font-medium text-xs text-slate-950">Identify & Consent</div>
            <p className="text-[11px] text-slate-500 font-normal leading-relaxed">
              Patient enters/scans ABHA ID, selects language, and gives audio-guided DPDP consent.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-2">
            ...
            <div className="font-medium text-xs text-slate-950">Converse & Intake</div>
            <p className="text-[11px] text-slate-500 font-normal leading-relaxed">
              AI conducts adaptive voice + touch SOCRATES interview; red flags trigger emergency triage.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-2">
            ...
            <div className="font-medium text-xs text-slate-950">Scan & Digitize</div>
            <p className="text-[11px] text-slate-500 font-normal leading-relaxed">
              Upload prior prescriptions and reports; OCR digitizes medications and abnormal lab ranges.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-2">
            ...
            <div className="font-medium text-xs text-slate-950">Summarize & Route</div>
            <p className="text-[11px] text-slate-500 font-normal leading-relaxed">
              FHIR history summary generated, linked to ABHA, and pushed live to doctor's OPD screen.
            </p>
          </div>
          ...
          <div className="p-4 rounded-2xl bg-white border border-slate-200/90 shadow-2xs space-y-2">
            ...
            <div className="font-medium text-xs text-slate-950">Consult & Sign-Off</div>
            <p className="text-[11px] text-slate-500 font-normal leading-relaxed">
              Physician reviews complete history in seconds, edits/confirms, and prescribes treatment.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="voice-intake" className="w-full text-center space-y-4 pt-4 border-t border-slate-200/80">
        <div>
          <span className="text-xs uppercase tracking-wider text-slate-400 font-medium">
          ...
          <p className="text-xs sm:text-sm text-slate-500 font-normal mt-1 max-w-md mx-auto">
            Test the live 3D holographic sound visualizer, natural clinical reasoning, and neural text-to-speech.
          </p>
        </div>
